...
import { FaArrowRight, FaSchool, FaLock } from "react-icons/fa6"
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:gap-2">
        ...
        {/* <div className="flex flex-1 flex-col gap-2">
          ...
          <div className="group relative flex items-center">
            ...
            <select
              {...register("classLevel", {
                required: "Please select your class level",
              })}
          ...
          <ErrorMessage message={errors.classLevel?.message} />
        </div> */}
        <div className="flex flex-1 flex-col gap-2">
          <label className="ml-2 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-text-secondary">
            Class Level
          ...
          <div className="group relative flex items-center">
            ...
            <input
              {...register("classLevel", {
                ...
                minLength: {
                  value: 3,
                  message: "Class level must be at least 3 characters",
                },
              })}
              className={getInputClass(!!errors.classLevel)}
